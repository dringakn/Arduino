...
Purpose:	The following program consist of two parts. Setup will initialize the robot while the loop will run indefnitely
			to repeatedly turn on the LED. You can use the robot terminal program to connect and configure robot parameters.
...
void loop() {
	/*
		Turn on the Robot LED
	*/
	digitalWrite(robot.LED, HIGH);
}
