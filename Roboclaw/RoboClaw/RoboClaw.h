...
#define _RC_VERSION 11 // software version of this library
#ifndef GCC_VERSION
#define GCC_VERSION (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif

#define _SS_VERSION 17
...
enum S3Mode {
	// Allowed S3 Pin Functions
	DEFAULTS_S3 = 0x34,
	ESTOP_LATCHING_S3 = SIGFLAG_LATCH | SIGTYPE_ESTOP,
	ESTOP_LATCHING_S3_INV = SIGFLAG_LATCH | SIGTYPE_ESTOP | SIGFLAG_INV,
	ESTOP_S3 = SIGTYPE_ESTOP,
	ESTOP_S3_INV = SIGTYPE_ESTOP | SIGFLAG_INV,
	VOLTAGE_CLAMP_S3 = SIGFLAG_CLAMP | SIGTYPE_EX,
	VOLTAGE_CLAMP_S3_INV = SIGFLAG_CLAMP | SIGTYPE_EX | SIGFLAG_INV,
	RS485_DIRECTION = SIGFLAG_RS485 | SIGTYPE_EX,
	RS485_DIRECTION_INV = SIGFLAG_RS485 | SIGTYPE_EX | SIGFLAG_INV,
	ENCODERS_ENABLE_DISABLE = SIGFLAG_ENCMODE
};

enum SXMode {
	// Allowed S4 and S5 Pins Functions
	DISABLED = 0x34,
	ESTOP_LATCHING = SIGFLAG_LATCH | SIGTYPE_ESTOP,
	ESTOP_LATCHING_INV = SIGFLAG_LATCH | SIGTYPE_ESTOP | SIGFLAG_INV,
	ESTOP = SIGTYPE_ESTOP,
	ESTOP_INV = SIGTYPE_ESTOP | SIGFLAG_INV,
	VOLTAGE_CLAMP = SIGFLAG_CLAMP | SIGTYPE_EX,
	VOLTAGE_CLAMP_INV = SIGFLAG_CLAMP | SIGTYPE_EX | SIGFLAG_INV,
	BRAKE = SIGFLAG_BRAKE | SIGTYPE_EX,
	BRAKE_INV = SIGFLAG_BRAKE | SIGTYPE_EX | SIGFLAG_INV,
	HOME_AUTO = 0x04,//0x04??
	HOME_AUTO_INV = 0x04 | SIGFLAG_INV,//0x04??
	HOME_USER = 0x62,//0x62??
	HOME_USER_INV = 0x62 | SIGFLAG_INV,//0x62??
	HOME_AUTO_LIMIT_FORWARD = SIGFLAG_HOME | SIGTYPE_LIMIT,//??
	HOME_AUTO_LIMIT_FORWARD_INV = SIGFLAG_HOME | SIGTYPE_LIMIT | SIGFLAG_INV,//??
	HOME_USER_LIMIT_FORWARD = SIGFLAG_HOME | SIGTYPE_LIMIT,
	HOME_USER_LIMIT_FORWARD_INV = SIGFLAG_HOME | SIGTYPE_LIMIT | SIGFLAG_INV,
	LIMIT_FORWARD = SIGFLAG_FOREWARD | SIGTYPE_LIMIT,
	LIMIT_FORWARD_INV = SIGFLAG_FOREWARD | SIGTYPE_LIMIT | SIGFLAG_INV,
	LIMIT_REVERSE = SIGFLAG_BACKWARD | SIGTYPE_LIMIT,
	LIMIT_REVERSE_INV = SIGFLAG_BACKWARD | SIGTYPE_LIMIT | SIGFLAG_INV,
	LIMIT_BOTH = SIGTYPE_LIMIT,
	LIMIT_BOTH_INV = SIGTYPE_LIMIT | SIGFLAG_INV,
};
